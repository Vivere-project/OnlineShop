...
namespace OnlineShop.Persistence.Migrations
{
    ...
    [Migration("20220622203827_MakeItemFieldsUnrequired")]
    partial class MakeItemFieldsUnrequired
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Domain.ItemColor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineShop.Domain.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineShop.Domain.Item", b =>
                {
                    b.HasOne("OnlineShop.Domain.ItemColor", "Color")
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineShop.Domain.Order", b =>
                {
                    b.HasOne("OnlineShop.Domain.Status", "Status")
                        .WithMany()
